...
import com.example.springsecurity.model.Cart;
...
public class MainController {
    ...
    @Autowired
    public MainController(CartRepository cartRepository, ProductService productService, OrderRepository orderRepository) {
