...
//
//        //Получаем логин с формы аутентификации с помощью Spring Security
//
...
//        }
//        //Возвращаем объект аутентификации. В объекте будут лежать объект модели, пароль, права доступа, ролей нет
